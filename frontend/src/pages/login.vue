<template>
  <div class="login-box body_login">
    <h1>Login</h1>
    <form class="form_login_normal">
      <input type="email" placeholder="Email" class="input_login_normal" v-model="email" @keyup.enter="login">
      <input type="password" placeholder="Password" class="input_login_normal" v-model="password" @keyup.enter="login">
    ...
    <div>
      <router-link class="text-decoration-none" :to="{ name: 'register' }"><button class="btn btn--large">no account?
